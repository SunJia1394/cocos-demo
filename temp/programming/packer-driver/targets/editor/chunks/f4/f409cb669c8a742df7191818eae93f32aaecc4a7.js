    ...
    execute: function () {
      ...
      _export("default", CubismPhysicsSubRig = (_dec = ccclass('CubismPhysicsSubRig'), _dec2 = property({
        ...
        updateOutputParameterValue(parameter, parameterValue, translation, output) {
          ...
          const weight = output.weight / (_crd && CubismPhysics === void 0 ? (_reportPossibleCrUseOfCubismPhysics({
            error: Error()
        ...
        updateParticles(strand, totalTranslation, totalAngle, wind, thresholdValue, deltaTime) {
          ...
          const totalRadian = (_crd && CubismPhysicsMath === void 0 ? (_reportPossibleCrUseOfCubismPhysicsMath({
            error: Error()
          }), CubismPhysicsMath) : CubismPhysicsMath).degreesToRadian(totalAngle);
          const currentGravity = (_crd && CubismPhysicsMath === void 0 ? (_reportPossibleCrUseOfCubismPhysicsMath({
            error: Error()
          ...
          for (let i = 1; i < strand.length; i++) {
            ...
            const direction = (() => {
              ...
              const radian = (_crd && CubismPhysicsMath === void 0 ? (_reportPossibleCrUseOfCubismPhysicsMath({
                error: Error()
        ...
        evaluate(deltaTime) {
          ...
          for (let i = 0; i < this.input.length; i++) {
            ...
            const weight = input.weight / (_crd && CubismPhysics === void 0 ? (_reportPossibleCrUseOfCubismPhysics({
              error: Error()
            }), CubismPhysics) : CubismPhysics).maximumWeight;
          ...
          const radAngle = (_crd && CubismPhysicsMath === void 0 ? (_reportPossibleCrUseOfCubismPhysicsMath({
            error: Error()
          }), CubismPhysicsMath) : CubismPhysicsMath).degreesToRadian(-totalAngle);
          {
        ...
        stabilization() {
          ...
          for (let i = 0; i < this.output.length; i++) {
            ...
            const translation = (_crd && MathExtensions === void 0 ? (_reportPossibleCrUseOfMathExtensions({
              error: Error()
