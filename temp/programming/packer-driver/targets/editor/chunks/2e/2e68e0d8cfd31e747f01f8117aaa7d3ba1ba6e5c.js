System.register(["cc", "__unresolved_0", "__unresolved_1"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Enum, CCInteger, CCFloat, game, math, CubismHarmonicMotionDirection, CubismParameter, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, ccclass, property, CubismHarmonicMotionParameter;
  ...
  return {
    setters: [function (_cc) {
      ...
      CubismHarmonicMotionDirection = _unresolved_.default;
    ...
    execute: function () {
      ...
      _export("default", CubismHarmonicMotionParameter = (_dec = ccclass('CubismHarmonicMotionParameter'), _dec2 = property({
        ...
        type: Enum(CubismHarmonicMotionDirection),
        serializable: true,
        visible: true
      }), _dec4 = property({
        type: CCFloat,
        ...
        evaluate() {
          ...
          let range = this.normalizedRange * this.valueRange; // Clamp the range so that it stays within the limits.
        ...
        clamp(origin, range) {
          switch (this.direction) {
            ...
            default:
              {
                // Nothing to do.
                const neverCheck = this.direction;
                break;
              }
        ...
        writable: true,
        initializer: function () {
          return CubismHarmonicMotionDirection.Left;
        }
...
//# sourceMappingURL=2e68e0d8cfd31e747f01f8117aaa7d3ba1ba6e5c.js.map