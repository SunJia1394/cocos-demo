  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", CubismLookParameter = (_dec = ccclass('CubismLookParameter'), _dec2 = property({
        ...
        reset() {
          const parameter = this.getComponent(CubismParameter); // Fail silently.
        ...
        tickAndEvaluate(targetOffset) {
          const result = this.axis == CubismLookAxis.X ? targetOffset.x : this.axis == CubismLookAxis.Z ? targetOffset.z : targetOffset.y;
