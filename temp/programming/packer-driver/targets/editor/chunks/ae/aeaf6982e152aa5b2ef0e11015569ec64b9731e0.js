    ...
    execute: function () {
      ...
      _export("default", CubismMotionApplier = (_dec = ccclass('CubismMotionApplier'), _dec2 = requireComponent(animation.AnimationController), _dec3 = requireComponent(_crd && CubismModel === void 0 ? (_reportPossibleCrUseOfCubismModel({
        ...
        refresh() {
          ...
          const model = this.getComponent(_crd && CubismModel === void 0 ? (_reportPossibleCrUseOfCubismModel({
            error: Error()
        ...
        valueUpdate(clipStatuses, progress, transProgress = 1.0) {
          ...
          for (let i = 0; i < ctrl.layerCount; i++) {
            ...
            if (currentTransition != null) {
              ...
              if (nextStateStatus == null) {
                ...
                const transProgress = currentTransition.duration == 0 ? 1.0 : currentTransition.time / currentTransition.duration;
