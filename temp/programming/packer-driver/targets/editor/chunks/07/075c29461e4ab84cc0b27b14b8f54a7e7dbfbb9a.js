      ...
      _export("default", CubismFadeController = (_dec = ccclass('CubismFadeController'), _dec2 = property(_crd && CubismFadeMotionList === void 0 ? (_reportPossibleCrUseOfCubismFadeMotionList({
        ...
        updateFade(fadeState) {
          ...
          for (let i = 0; i < playingMotions.length; i++) {
            ...
            const fadeInWeight = fadeInTime <= 0.0 ? 1.0 : (_crd && CubismFadeMath === void 0 ? (_reportPossibleCrUseOfCubismFadeMath({
              error: Error()
            }), CubismFadeMath) : CubismFadeMath).getEasingSine(elapsedTime / fadeInTime);
            const fadeOutWeight = fadeOutTime <= 0.0 ? 1.0 : (_crd && CubismFadeMath === void 0 ? (_reportPossibleCrUseOfCubismFadeMath({
              error: Error()
