System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Node, _crd, ObjectExtensionMethods;
    ...
    execute: function () {
      ...
      (function (_ObjectExtensionMethods) {
        function getInterface(self, isImplementsFunc) {
          ...
          let node = self;
          const handlers = node.getComponents(Component).filter((value, _index, _array) => isImplementsFunc(value));
          let result = null;
        ...
        function toNullUnlessImplementsInterface(self, isImplementsFunc) {
          const exposesInterface = implementsInterface(self, isImplementsFunc); // Warn on error.
...
//# sourceMappingURL=11052b353af3e4ec02f40ee70c3c9dc9f55c8e12.js.map