    ...
    execute: function () {
      ...
      _export("default", CubismRaycaster = (_dec = ccclass('CubismRaycaster'), _dec(_class = class CubismRaycaster extends Component {
        ...
        refresh() {
          ...
          const candidates = (_findCubismModel$draw = (_findCubismModel = (_crd && ComponentExtensionMethods === void 0 ? (_reportPossibleCrUseOfComponentExtensionMethods({
            error: Error()
          ...
          for (var i = 0; i < candidates.length; i++) {
            ...
            const renderer = candidates[i].getComponent(_crd && CubismRenderer === void 0 ? (_reportPossibleCrUseOfCubismRenderer({
              error: Error()
            }), CubismRenderer) : CubismRenderer);
            console.assert(renderer);
            raycastables.push(renderer);
            const raycastable = candidates[i].getComponent(_crd && CubismRaycastable === void 0 ? (_reportPossibleCrUseOfCubismRaycastable({
              error: Error()
        ...
        raycast2(ray, result, maximumDistance = Number.POSITIVE_INFINITY) {
          ...
          const origin = (_crd && Vector3 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
          }), Vector3) : Vector3).from(ray.o);
          const direction = (_crd && Vector3 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
          }), Vector3) : Vector3).from(ray.d);
          const intersectionInWorldSpace = origin.add(direction.multiplySingle(direction.z / origin.z));
          let intersectionInLocalSpace = (_crd && Vector3 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
