System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, RichText, Camera, geometry, input, Input, math, game, CubismModel, CubismRaycaster, CubismRaycastHit, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, RaycastHitDisplay;
  ...
  function _reportPossibleCrUseOfCubismRaycaster(extras) {
    _reporterNs.report("CubismRaycaster", "../../Framework/Raycasting/CubismRaycaster", _context.meta, extras);
  }

  function _reportPossibleCrUseOfCubismRaycastHit(extras) {
    _reporterNs.report("CubismRaycastHit", "../../Framework/Raycasting/CubismRaycastHit", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CubismRaycaster = _unresolved_3.default;
    }, function (_unresolved_4) {
      CubismRaycastHit = _unresolved_4.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("RaycastHitDisplay", RaycastHitDisplay = (_dec = ccclass('RaycastHitDisplay'), _dec2 = property({
        type: _crd && CubismModel === void 0 ? (_reportPossibleCrUseOfCubismModel({
          error: Error()
        ...
        doRaycast() {
          ...
          const y = _mouseDownEventData.y / game.canvas.height; // Cast ray from pointer position.
          // Input.mousePosition

          const ray = camera.screenPointToRay(_mouseDownEventData.x, _mouseDownEventData.y, new geometry.Ray());
          const hitCount = raycaster.raycast2(ray, this.results); // Return early if nothing was hit.
        ...
        start() {
          ...
          this.raycaster = model.getComponent(_crd && CubismRaycaster === void 0 ? (_reportPossibleCrUseOfCubismRaycaster({
            error: Error()
          }), CubismRaycaster) : CubismRaycaster);

          for (let i = 0; i < results.length; i++) {
            results[i] = new (_crd && CubismRaycastHit === void 0 ? (_reportPossibleCrUseOfCubismRaycastHit({
              error: Error()
...
//# sourceMappingURL=4704329b97b469332e958abb972dee12fe644d82.js.map