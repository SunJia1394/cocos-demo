      ...
      _export("default", CubismMaskController = (_dec = ccclass('CubismMaskController'), _dec2 = property({
        ...
        forceRevive() {
          ...
          for (var i = 0; i < this.junctions.length; ++i) {
            ...
            const masks = new Array(pairs.entries[i].masks.length);

            for (var j = 0; j < masks.length; ++j) {
              masks[j] = new (_crd && CubismMaskRenderer === void 0 ? (_reportPossibleCrUseOfCubismMaskRenderer({
                error: Error()
            ...
            this.junctions[i] = new (_crd && CubismMaskMaskedJunction === void 0 ? (_reportPossibleCrUseOfCubismMaskMaskedJunction({
              error: Error()
            }), CubismMaskMaskedJunction) : CubismMaskMaskedJunction)().setMasks(masks).setMaskeds(pairs.entries[i].maskeds).setMaskTexture(this.maskTexture);
          }
        }
      ...
      _export("MasksMaskedsPairs", MasksMaskedsPairs = class MasksMaskedsPairs {
        ...
        add(masked, masks) {
          ...
          for (let i = 0; i < this.entries.length; i++) {
            ...
            const renderer = masked.getComponent(_crd && CubismRenderer === void 0 ? (_reportPossibleCrUseOfCubismRenderer({
              error: Error()
            }), CubismRenderer) : CubismRenderer);
          ...
          const renderers = new Array(masks.length);

          for (let i = 0; i < masks.length; i++) {
            const renderer = masks[i].getComponent(_crd && CubismRenderer === void 0 ? (_reportPossibleCrUseOfCubismRenderer({
              error: Error()
            }), CubismRenderer) : CubismRenderer);
