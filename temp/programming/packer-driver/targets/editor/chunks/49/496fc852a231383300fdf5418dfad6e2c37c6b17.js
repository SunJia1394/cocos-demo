      ...
      CubismPhysics3Json = class CubismPhysics3Json {
        ...
        static loadFromJson(json) {
          ...
          if (Array.isArray(json.PhysicsSettings)) {
            const physicsSettings = JsonParseUtils.arrayedInstantiateFromJson(json.PhysicsSettings, SerializablePhysicsSettings.instantiateFromJson);
      ...
      (function (_CubismPhysics3Json) {
        ...
        class SerializablePhysicsSettings {
          ...
          static instantiateFromJson(json) {
            ...
            const id = asString(json.Id);
            const input = JsonParseUtils.arrayedInstantiateFromJson(json.Input, SerializableInput.instantiateFromJson);
            const output = JsonParseUtils.arrayedInstantiateFromJson(json.Output, SerializableOutput.instantiateFromJson);
            const vertices = JsonParseUtils.arrayedInstantiateFromJson(json.Vertices, SerializableVertex.instantiateFromJson);
