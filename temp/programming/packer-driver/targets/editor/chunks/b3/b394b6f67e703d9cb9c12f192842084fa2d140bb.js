System.register(["cc", "__unresolved_0", "cc/env"], function (_export, _context) {
  ...
  return {
    setters: [function (_cc) {
      ...
      CubismMaskTexture = _unresolved_.default;
    }, function (_ccEnv) {
    ...
    execute: function () {
      ...
      _export("default", CubismMaskCommandBuffer = (_dec = ccclass('CubismMaskCommandBuffer'), _dec2 = requireComponent([Camera]), _dec(_class2 = disallowMultiple(_class2 = _dec2(_class2 = executeInEditMode(_class2 = (_class3 = class CubismMaskCommandBuffer extends Component {
        ...
        static initialize() {
          ...
          // Spawn update proxy.
          const proxyName = 'cubism_MaskCommandBuffer';
          let proxy = null; // @ts-ignore

          const persistRootNodes = director._persistRootNodes;
        ...
        static refreshCommandBuffer() {
          ...
          for (let i = 0; i < renderers.length; i++) {
            const meta = Reflect.get(renderers[i], CubismMaskCommandBuffer.metadataPropertySymbol);
        ...
        onLoad() {
          var _CubismMaskTexture$gl, _CubismMaskTexture$gl2;
          ...
          const targetTexture = (_CubismMaskTexture$gl = (_CubismMaskTexture$gl2 = CubismMaskTexture.globalMaskTexture) == null ? void 0 : _CubismMaskTexture$gl2.getTextureReference()) != null ? _CubismMaskTexture$gl : null;
...
//# sourceMappingURL=b394b6f67e703d9cb9c12f192842084fa2d140bb.js.map