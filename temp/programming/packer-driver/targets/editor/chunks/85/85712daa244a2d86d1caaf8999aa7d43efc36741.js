    ...
    execute: function () {
      ...
      _export("default", CubismPhysicsInput = (_dec = ccclass('CubismPhysicsInput'), _dec2 = property({
        ...
        getInputTranslationXFromNormalizedParameterValue(targetTranslation, targetAngle, parameter, parameterValue, normalization, weight) {
          const result = CubismPhysicsMath.normalize(parameter, parameterValue, normalization.position.minimum, normalization.position.maximum, normalization.position.default, this.isInverted);
          return {
        ...
        getInputAngleFromNormalizedParameterValue(targetTranslation, targetAngle, parameter, parameterValue, normalization, weight) {
          const result = CubismPhysicsMath.normalize(parameter, parameterValue, normalization.angle.minimum, normalization.angle.maximum, normalization.angle.default, this.isInverted);
          return {
