System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfCubismMotion3Json(extras) {
    _reporterNs.report("CubismMotion3Json", "../Json/CubismMotion3Json", _context.meta, extras);
  }

  function _reportPossibleCrUseOfCubismSerializableCurve(extras) {
    _reporterNs.report("CubismSerializableCurve", "./CubismSerializableCurve", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CubismMotion3Json = _unresolved_2.default;
    }, function (_unresolved_3) {
      CubismSerializableCurve = _unresolved_3.default;
    }, function (_unresolved_4) {
      CubismSerializableKeyFrame = _unresolved_4.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", CubismFadeMotionData = (_dec = ccclass('CubismFadeMotionData'), _dec2 = property(CCString), _dec3 = property(CCFloat), _dec4 = property(CCFloat), _dec5 = property([CCString]), _dec6 = property([_crd && CubismSerializableCurve === void 0 ? (_reportPossibleCrUseOfCubismSerializableCurve({
        error: Error()
      }), CubismSerializableCurve) : CubismSerializableCurve]), _dec7 = property([CCFloat]), _dec8 = property([CCFloat]), _dec9 = property(CCFloat), _dec(_class = (_class2 = class CubismFadeMotionData extends Asset {
        onLoaded() {
        ...
        internalConvertToCurves() {
          ...
          const oCurves = new Array(iCurves.length);
        ...
        static createInstance(motion3Json, motionName, motionLength, shouldImportAsOriginalWorkflow = false, isCallFromModelJson = false) {
        ...
        static toSetInstance(fadeMotion, motion3Json, motionName, motionLength, shouldImportAsOriginalWorkflow = false, isCallFormModelJson = false) {
          ...
          if (parameterIds != null && parameterFadeInTimes != null && parameterFadeOutTimes != null) {
            ...
            for (let i = 0; i < jsonCurves.length; i++) {
              const curve = jsonCurves[i]; // In original workflow mode, skip add part opacity curve when call not from model3.json.
              ...
              const keys = (_crd && CubismMotion3Json === void 0 ? (_reportPossibleCrUseOfCubismMotion3Json({
                error: Error()
              }), CubismMotion3Json) : CubismMotion3Json).convertCurveSegmentsToKeyframes(curve.segments);
              internalParameterCurves[i] = new (_crd && CubismSerializableCurve === void 0 ? (_reportPossibleCrUseOfCubismSerializableCurve({
                error: Error()
              }), CubismSerializableCurve) : CubismSerializableCurve)(keys.length);
              ...
              for (let j = 0; j < keys.length; j++) {
                ...
                const keyFrame = new (_crd && CubismSerializableKeyFrame === void 0 ? (_reportPossibleCrUseOfCubismSerializableKeyFrame({
                  error: Error()
                }), CubismSerializableKeyFrame) : CubismSerializableKeyFrame)(t, v.value, v.leftTangent, v.leftTangentWeight, v.rightTangent, v.rightTangentWeight);
        ...
        static deserializeFromJson(json) {
          ...
          const instance = new CubismFadeMotionData(motionName, fadeInTime, fadeOutTime, parameterIds, internalParameterCurves, parameterFadeInTimes, parameterFadeOutTimes, motionLength);
          return instance;
        }
      ...
      (function (_CubismSerializableCurves) {
        function instantiateFromJson(src) {
          ...
          for (let i = 0; i < src.length; i++) {
            const curve = (_crd && CubismSerializableCurve === void 0 ? (_reportPossibleCrUseOfCubismSerializableCurve({
              error: Error()
            }), CubismSerializableCurve) : CubismSerializableCurve).instantiateFromJson(src[i]);
...
//# sourceMappingURL=85de8ec25859c4926c5cafcbea16d9278afb9a03.js.map