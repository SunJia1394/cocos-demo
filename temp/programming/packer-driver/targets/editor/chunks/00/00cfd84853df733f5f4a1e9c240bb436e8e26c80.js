System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, JsonParseUtils, CubismPose3Json, _crd, asArray, asNumber, asString;
      ...
      CubismPose3Json = class CubismPose3Json {
        ...
        static loadFrom(pose3Json) {
          const json = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
            error: Error()
          }), JsonParseUtils) : JsonParseUtils).parse(pose3Json);
        ...
        static loadFromJson(json) {
          ...
          const fadeInTime = (_asNumber = asNumber(json.FadeInTime)) != null ? _asNumber : 0.5;
        ...
        static parseGroups(src) {
          ...
          let groups = Array(obj.length);

          for (let i = 0; i < groups.length; i++) {
            const group = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
            }), JsonParseUtils) : JsonParseUtils).arrayedInstantiateFromJson(obj[i], CubismPose3Json.SerializablePoseGroup.instantiateFromJson);
      ...
      (function (_CubismPose3Json) {
        class SerializablePoseGroup {
          ...
          static instantiateFromJson(json) {
            ...
            const link = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
            }), JsonParseUtils) : JsonParseUtils).arrayedInstantiateFromJson(json.Link, asString);
            return new SerializablePoseGroup({
              id: id,
              link: link
            });
...
//# sourceMappingURL=00cfd84853df733f5f4a1e9c240bb436e8e26c80.js.map