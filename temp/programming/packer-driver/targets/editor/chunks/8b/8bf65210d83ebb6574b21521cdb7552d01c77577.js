    ...
    execute: function () {
      ...
      _export("default", CubismDisplayInfo3Json = class CubismDisplayInfo3Json {
        ...
        static loadFromJson(json) {
          ...
          const parameterGroups = JsonParseUtils.arrayedInstantiateFromJson(json.Parameters, SerializableParameterGroups.instantiateFromJson);
          const parts = JsonParseUtils.arrayedInstantiateFromJson(json.Parts, SerializableParts.instantiateFromJson);

          if (version === undefined || parameterGroups === undefined || parts === undefined) {
            return null;
          }

          const parameters = (_JsonParseUtils$array = JsonParseUtils.arrayedInstantiateFromJson(json.Parameters, SerializableParameters.instantiateFromJson)) != null ? _JsonParseUtils$array : new Array(0);
