System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, CCFloat, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, ccclass, property, CubismPart;
    ...
    execute: function () {
      ...
      _export("default", CubismPart = (_dec = ccclass('CubismPart'), _dec2 = property({
        ...
        static createParts(model) {
          const _root = new Node('Parts'); // Create parts.


          const _parts = model.parts;

          const _buffer = new Array(_parts.count);
...
//# sourceMappingURL=56de6bbcb86d63aaa2c46899c351158fdec230d9.js.map