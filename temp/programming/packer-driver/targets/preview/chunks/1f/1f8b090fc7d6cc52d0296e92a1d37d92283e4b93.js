System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Asset, _decorator, Moc, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, CubismMoc;
  ...
  function _reportPossibleCrUseOfMoc(extras) {
    _reporterNs.report("Moc", "../CubismCore", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("default", CubismMoc = (_dec = ccclass('CubismMoc'), _dec2 = property({
        ...
        hasMocConsistency(mocByte) {
          return (_crd && Moc === void 0 ? (_reportPossibleCrUseOfMoc({
            error: Error()
          }), Moc) : Moc).hasMocConsistency(mocByte) === 1 ? true : false;
        }
        /**
        ...
        revive() {
          ...
          this.unmanagedMoc = (_crd && Moc === void 0 ? (_reportPossibleCrUseOfMoc({
            error: Error()
          }), Moc) : Moc).fromArrayBuffer(this.bytes);
        }
...
//# sourceMappingURL=1f8b090fc7d6cc52d0296e92a1d37d92283e4b93.js.map