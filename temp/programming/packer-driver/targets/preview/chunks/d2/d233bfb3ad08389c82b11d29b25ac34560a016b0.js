System.register(["cc", "__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "cc/env"], function (_export, _context) {
  "use strict";

  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCFloat, CCInteger, Enum, CCObject, Camera, math, Node, Component, Asset, CubismRenderer, InEditorSymbols, CubismSortingMode, CubismUpdateExecutionOrder, CubismUpdateController, ObjectExtensionMethods, ICubismUpdatable, CoreComponentExtensionMethods, FrameworkComponentExtensionMethods, ICubismDrawOrderHandler, ICubismOpacityHandler, ICubismBlendColorHandler, EDITOR, _ICubismUpdatable$SYM, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, ccclass, property, executeInEditMode, CubismRenderController;
  ...
  return {
    setters: [function (_cc) {
      ...
      CubismRenderer = _unresolved_.default;
      InEditorSymbols = _unresolved_.CubismRendererInEditorSymbols;
    }, function (_unresolved_2) {
      CubismSortingMode = _unresolved_2.default;
    }, function (_unresolved_3) {
      CubismUpdateExecutionOrder = _unresolved_3.default;
    }, function (_unresolved_4) {
      CubismUpdateController = _unresolved_4.default;
    }, function (_unresolved_5) {
      ObjectExtensionMethods = _unresolved_5.default;
      ...
      ICubismDrawOrderHandler = _unresolved_9.default;
    }, function (_unresolved_10) {
      ICubismOpacityHandler = _unresolved_10.default;
    }, function (_unresolved_11) {
      ICubismBlendColorHandler = _unresolved_11.default;
    }, function (_ccEnv) {
    ...
    execute: function () {
      ...
      _export("default", CubismRenderController = (_dec = ccclass('CubismRenderController'), _dec2 = property({
        ...
        type: Node
      }), _dec(_class = executeInEditMode(_class = (_class2 = (_ICubismUpdatable$SYM = ICubismUpdatable.SYMBOL, class CubismRenderController extends Component {
        constructor() {
          super(...arguments);
        ...
        set sortingMode(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i = 0; _i < renderers.length; _i++) {
              console.assert(renderers[_i][InEditorSymbols.onControllerSortingModeDidChange] != null);

              renderers[_i][InEditorSymbols.onControllerSortingModeDidChange](this._sortingOrder);
            }
          }
        }
        ...
        set sortingOrder(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i2 = 0; _i2 < renderers.length; _i2++) {
              console.assert(renderers[_i2][InEditorSymbols.onControllerSortingOrderDidChange] != null);

              renderers[_i2][InEditorSymbols.onControllerSortingOrderDidChange](this._sortingOrder);
            }
          }
        }
        ...
        set drawOrderHandler(value) {
          this._drawOrderHandler = ObjectExtensionMethods.toNullUnlessImplementsInterface(value, ICubismDrawOrderHandler.isImplements);
        }
        ...
        get drawOrderHandlerInterface() {
          if (this._drawOrderHandlerInterface == null) {
            ...
            this._drawOrderHandlerInterface = ObjectExtensionMethods.getInterface(this.drawOrderHandler, ICubismDrawOrderHandler.isImplements);
          }
        ...
        set opacityHandler(value) {
          this._opacityHandler = ObjectExtensionMethods.toNullUnlessImplementsInterface(value, ICubismOpacityHandler.isImplements);
        }
        ...
        get opacityHandlerInterface() {
          if (this._opacityHandlerInterface == null) {
            ...
            this._opacityHandlerInterface = ObjectExtensionMethods.getInterface(this.opacityHandler, ICubismOpacityHandler.isImplements);
          }
        ...
        get multiplyColorHandlerInterface() {
          if (this._multiplyColorHandlerInterface == null) {
            ...
            this._multiplyColorHandlerInterface = ObjectExtensionMethods.getInterface(this.multiplyColorHandler, ICubismBlendColorHandler.isImplements);
          }
        ...
        get screenColorHandlerInterface() {
          if (this._screenColorHandlerInterface == null) {
            ...
            this._screenColorHandlerInterface = ObjectExtensionMethods.getInterface(this.screenColorHandler, ICubismBlendColorHandler.isImplements);
          }
        ...
        set depthOffset(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i3 = 0; _i3 < renderers.length; _i3++) {
              console.assert(renderers[_i3][InEditorSymbols.onControllerDepthOffsetDidChange] != null);

              renderers[_i3][InEditorSymbols.onControllerDepthOffsetDidChange](this._depthOffset);
            }
          }
        } //#endregion
        //#region Model
        ...
        get drawablesRootTransform() {
          if (this._drawablesRootTransform == null) {
            ...
            var drawables = (_this$model = this.model) == null ? void 0 : _this$model.drawables;
        ...
        get renderers() {
          if (this._renderers == null) {
            ...
            this._renderers = FrameworkComponentExtensionMethods.getComponentsMany(drawables, CubismRenderer);
          }
        ...
        tryInitializeRenderers() {
          // Try get renderers.
          var renderers = this.renderers; // Create renderers if necesssary.

          if (renderers == null || renderers.length == 0) {
            var _CoreComponentExtensi, _CoreComponentExtensi2;

            // Create renders and apply it to backing field...
            var drawables = (_CoreComponentExtensi = (_CoreComponentExtensi2 = CoreComponentExtensionMethods.findCubismModel(this)) == null ? void 0 : _CoreComponentExtensi2.drawables) != null ? _CoreComponentExtensi : null;

            if (drawables == null) {
              return;
            }

            renderers = FrameworkComponentExtensionMethods.addComponentEach(drawables, CubismRenderer); // Store renderers.
        ...
        updateOpacity() {
          ...
          var applyOpacityToRenderers = this.opacityHandlerInterface == null || this.opacity > 1 - math.EPSILON;
        ...
        updateBlendColors() {
          ...
          var newMultiplyColors = new Array(this.renderers.length);
          var newScreenColors = new Array(this.renderers.length);

          for (var i = 0; i < this.renderers.length; i++) {
            var isUseUserMultiplyColor = this.renderers[i].overwriteFlagForDrawableMultiplyColors || this.overwriteFlagForModelMultiplyColors;
            ...
            var isUseUserScreenColor = this.renderers[i].overwriteFlagForDrawableScreenColor || this.overwriteFlagForModelScreenColors;
        ...
        onLateUpdate() {
          ...
          var cameraRot = this.cameraToFace.node.getWorldRotation();

          if (EDITOR) {
            var _this$drawablesRootTr;

            var drawRot = (_this$drawablesRootTr = this.drawablesRootTransform) == null ? void 0 : _this$drawablesRootTr.getWorldRotation();
        ...
        onDynamicDrawableData(sender, data) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            var swapMeshes = false; // Update visibility if last SwapInfo flag is true.
          ...
          var drawOrderHandler = this.drawOrderHandlerInterface;

          if (drawOrderHandler != null) {
            for (var _i4 = 0; _i4 < data.length; _i4++) {
              if (data[_i4].isDrawOrderDirty) {
                drawOrderHandler.onDrawOrderDidChange(this, drawables[_i4], data[_i4].drawOrder);
              }
            }
          }
          ...
          var isMultiplyColorUpdated = false;
          var isScreenColorUpdated = false;
          var newMultiplyColors = new Array(renderers.length);
          var newScreenColors = new Array(renderers.length);

          for (var _i5 = 0; _i5 < data.length; _i5++) {
            var isUseModelMultiplyColor = !(renderers[_i5].overwriteFlagForDrawableMultiplyColors || this.overwriteFlagForModelMultiplyColors); // Skip processing when not using model colors.

            if (data[_i5].isBlendColorDirty && isUseModelMultiplyColor) {
              renderers[_i5].applyMultiplyColor();

              isMultiplyColorUpdated = true;
            }

            newMultiplyColors[_i5] = renderers[_i5].multiplyColor;
          }

          for (var _i6 = 0; _i6 < data.length; _i6++) {
            var isUseModelScreenColor = !(renderers[_i6].overwriteFlagForDrawableScreenColor || this.overwriteFlagForModelScreenColors); // Skip processing when not using model colors.

            if (data[_i6].isBlendColorDirty && isUseModelScreenColor) {
              renderers[_i6].applyScreenColor();

              isScreenColorUpdated = true;
            }

            newScreenColors[_i6] = renderers[_i6].screenColor;
          } // Pass blend color changes to handler (if available).


          var multiplyColorHandlerInterface = this.multiplyColorHandlerInterface;
          var screenColorHandlerInterface = this.screenColorHandlerInterface;
        ...
        writable: true,
        initializer: function initializer() {
          return CubismSortingMode.backToFrontZ;
        }
...
//# sourceMappingURL=d233bfb3ad08389c82b11d29b25ac34560a016b0.js.map