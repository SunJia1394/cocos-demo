    ...
    execute: function () {
      ...
      _export("default", CubismExpressionController = (_dec = ccclass('CubismExpressionController'), _dec2 = property({
        ...
        startExpression() {
          ...
          var palyingExpression = (_crd && CubismPlayingExpression === void 0 ? (_reportPossibleCrUseOfCubismPlayingExpression({
            error: Error()
        ...
        onLateUpdate() {
          ...
          for (var expressionIndex = 0; expressionIndex < this._playingExpressions.length; ++expressionIndex) {
            ...
            var fadeIn = Math.abs(playingExpression.fadeInTime) < math.EPSILON ? 1.0 : (_crd && CubismFadeMath === void 0 ? (_reportPossibleCrUseOfCubismFadeMath({
              error: Error()
            }), CubismFadeMath) : CubismFadeMath).getEasingSine(playingExpression.expressionUserTime / playingExpression.fadeInTime);
            var fadeOut = Math.abs(playingExpression.expressionEndTime) < math.EPSILON || playingExpression.expressionEndTime < 0.0 ? 1.0 : (_crd && CubismFadeMath === void 0 ? (_reportPossibleCrUseOfCubismFadeMath({
              error: Error()
