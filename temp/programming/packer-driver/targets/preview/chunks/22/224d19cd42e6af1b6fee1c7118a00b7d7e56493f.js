System.register(["cc", "__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    setters: [function (_cc) {
      ...
      EditorUtils = _unresolved_5.EditorUtils;
      isImporter = _unresolved_5.isImporter;
    }],
    execute: function () {
      ...
      (function (_CubismRendererInEditorSymbols) {
        var onControllerSortingOrderDidChange = _CubismRendererInEditorSymbols.onControllerSortingOrderDidChange = Symbol.for('onControllerSortingOrderDidChange');
        var onControllerSortingModeDidChange = _CubismRendererInEditorSymbols.onControllerSortingModeDidChange = Symbol.for('onControllerSortingModeDidChange');
        var onControllerDepthOffsetDidChange = _CubismRendererInEditorSymbols.onControllerDepthOffsetDidChange = Symbol.for('onControllerDepthOffsetDidChange');
      ...
      _export("default", CubismRenderer = (_dec = ccclass('CubismRenderer'), _dec2 = requireComponent(MeshRenderer), _dec3 = property({
        ...
        constructor() {
          ...
          this._meshes = [CubismMeshPrimitive.makeEmpty(), CubismMeshPrimitive.makeEmpty()];
          //#endregion
          //#region FrontMesh
          // @property({ serializable: false, visible: false })
          this._frontMesh = 0;
        ...
        swapMeshes() {
          ...
          var mesh = this.meshes[this.frontMesh]; // Update colors.
        ...
        [_CubismRendererInEdit](newSortingMode) {
          EditorUtils.applyComponentProperty(this.node.uuid, this.uuid, 'sortingMode', newSortingMode, 'Enum').then(() => this.applySorting());
        }
        /**
        ...
        [_CubismRendererInEdit2](newSortingOrder) {
          EditorUtils.applyComponentProperty(this.node.uuid, this.uuid, 'sortingOrder', newSortingOrder, 'Float').then(() => this.applySorting());
        }
        /**
        ...
        [_CubismRendererInEdit3](newDepthOffset) {
          EditorUtils.applyComponentProperty(this.node.uuid, this.uuid, 'depthOffset', newDepthOffset, 'Float').then(() => this.applySorting());
        }
        /**
         * Sets the opacity.
        ...
        onDrawableVertexPositionsDidChange(newVertexPositions) {
          var mesh = this.mesh; // Apply positions and update bounds.
        ...
        onMaskPropertiesDidChange(newMaskProperties) {
          ...
          var maskTex = (_newMaskProperties$te = (_newMaskProperties$te2 = newMaskProperties.texture) == null ? void 0 : _newMaskProperties$te2.getTextureReference()) != null ? _newMaskProperties$te : null;
          var maskTile = newMaskProperties.tile.toVec4();
          var maskTransform = newMaskProperties.transform.toVec4();
          var meshRenderer = this.meshRenderer;
          ...
          var material = meshRenderer.getMaterialInstance(0);
        ...
        onModelOpacityDidChange(newModelOpacity) {
          ...
          // Write property.
          (_this$meshRenderer2 = this.meshRenderer) == null || (_this$meshRenderer2 = _this$meshRenderer2.material) == null ? void 0 : _this$meshRenderer2.setProperty(CubismShaderVariables.modelOpacity, newModelOpacity);
        } // #endregion
        ...
        applySorting() {
          ...
          if (CubismSortingMode.sortByOrder(this.sortingMode)) {
            this.meshRenderer.priority = this.sortingOrder + (this.sortingMode == CubismSortingMode.backToFrontOrder ? this.renderOrder + this.localSortingOrder : -(this.renderOrder + this.localSortingOrder));
          ...
          var offset = this.sortingMode == CubismSortingMode.backToFrontZ ? this.depthOffset : -this.depthOffset;
        ...
        applyVertexColors() {
          var vertexColors = this.vertexColors;
        ...
        applyMultiplyColor() {
          ...
          var renderer = this.meshRenderer;

          if (renderer) {
            var material = renderer.getMaterialInstance(0);
            material == null ? void 0 : material.setProperty(CubismShaderVariables.multiplyColor, this.multiplyColor);
          }
        }
        ...
        applyScreenColor() {
          ...
          if (renderer) {
            var material = renderer.getMaterialInstance(0);
            material == null ? void 0 : material.setProperty(CubismShaderVariables.screenColor, this.screenColor);
          }
        }
        /** Initializes the main texture if possible. */
        ...
        tryInitializeMesh() {
          ...
          var drawable = this.getComponent(CubismDrawable);
          ...
          for (var i = 0; i < 2; i++) {
            var primitive = drawable.generateMeshPrimitive();
      ...
      (function (_SwapInfo) {
        var DEFAULT = _SwapInfo.DEFAULT = new SwapInfo();
      })(SwapInfo || (SwapInfo = {}));
...
//# sourceMappingURL=224d19cd42e6af1b6fee1c7118a00b7d7e56493f.js.map