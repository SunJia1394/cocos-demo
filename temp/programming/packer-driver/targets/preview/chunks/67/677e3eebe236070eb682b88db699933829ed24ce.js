System.register(["cc", "__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "cc/env"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, game, Director, CubismDrawable, CubismParameter, CubismPart, ArrayExtensionMethods, CubismCanvasInformation, CubismParameterStore, CubismTaskableModel, CubismMoc, EDITOR, ModelUpdateFunctions, DynamicDrawableDataEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class3, _class4, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _init, _class5, ccclass, property, executeInEditMode, CubismModel;
  ...
  return {
    setters: [function (_cc) {
      ...
      ArrayExtensionMethods = _unresolved_4.default;
    }, function (_unresolved_5) {
      CubismCanvasInformation = _unresolved_5.default;
    }, function (_unresolved_6) {
      CubismParameterStore = _unresolved_6.default;
    }, function (_unresolved_7) {
      CubismTaskableModel = _unresolved_7.default;
    }, function (_unresolved_8) {
      CubismMoc = _unresolved_8.default;
    }, function (_ccEnv) {
    ...
    execute: function () {
      ...
      _export("default", CubismModel = (_dec = ccclass('CubismModel'), _dec2 = property({
        ...
        static instantiateFrom(moc) {
          ...
          var modelComp = node.addComponent(CubismModel); // Initialize it by resetting it.
        ...
        revive() {
          ...
          var model = CubismTaskableModel.createTaskableModel(this.moc);
        ...
        reset(moc) {
          ...
          var unmanagedModel = this.taskableModel.unmanagedModel; // Create and initialize proxies.

          var parameters = CubismParameter.createParameters(unmanagedModel);
          var parts = CubismPart.createParts(unmanagedModel);
          var drawables = CubismDrawable.createDrawables(unmanagedModel);
        ...
        onModelUpdate() {
          ...
          var frameCount = director.getTotalFrames();
...
//# sourceMappingURL=677e3eebe236070eb682b88db699933829ed24ce.js.map