System.register(["cc", "__unresolved_0", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, AudioSource, CCFloat, Component, Enum, math, _decorator, MathExtensions, CubismAudioSamplingQuality, CubismMouthController, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, ccclass, property, requireComponent, CubismAudioMouthInput;
  ...
  return {
    setters: [function (_cc) {
      ...
      MathExtensions = _unresolved_.MathExtensions;
    }, function (_unresolved_2) {
      CubismAudioSamplingQuality = _unresolved_2.default;
    }, function (_unresolved_3) {
      CubismMouthController = _unresolved_3.default;
    }],
    execute: function () {
      ...
      _export("default", CubismAudioMouthInput = (_dec = ccclass('CubismAudioMouthInput'), _dec2 = requireComponent(CubismMouthController), _dec3 = property(AudioSource), _dec4 = property({
        type: Enum(CubismAudioSamplingQuality)
      }), _dec5 = property({
        type: CCFloat,
        slide: true,
        range: [1.0, 10.0, 0.01]
        ...
        initSamples() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var sampleRatePromise = _this.audioInput.getSampleRate();

            var pcmPromise = _this.audioInput.getPCMData(0);

            var {
              0: sampleRate,
              1: pcm
            } = yield Promise.all([sampleRatePromise, pcmPromise]);

            if (pcm != null) {
              _this.samples = pcm;
              _this.sampleRate = sampleRate > 0 ? sampleRate : 0;
            }
        ...
        update(deltaTime) {
          ...
          var pos = trunc(currentTime * this.sampleRate);
          var length = 256;
          ...
          for (var i = 0; i < length; i++) {
            var sample = samples.getData((pos + i) % samples.length);
            total += sample * sample;
          } // Compute root mean square over samples.


          var rms = sqrt(total / length) * gain; // Clamp root mean square.

          rms = math.clamp01(rms); // Smooth rms.

          var output = MathExtensions.Float.smoothDamp(this.lastRms, rms, this.velocityBuffer, smoothing * 0.1, undefined, deltaTime);
          rms = output[0];
        ...
        writable: true,
        initializer: function initializer() {
          return CubismAudioSamplingQuality.high;
        }
...
//# sourceMappingURL=e33c7693c585e1d26b19454472e241a764deed5b.js.map