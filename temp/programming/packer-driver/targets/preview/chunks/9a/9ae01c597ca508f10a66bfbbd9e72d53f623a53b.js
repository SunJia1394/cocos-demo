    ...
    execute: function () {
      ...
      _export("default", CubismMaskRenderer = class CubismMaskRenderer {
        ...
        addToCommandBuffer(buffer) {
          ...
          var sym = CubismMaskCommandBuffer.metadataPropertySymbol;
          ...
          var maskRenderers = CubismMaskCommandBuffer.instance.getComponentsInChildren(MeshRenderer);
          ...
          if (!meta) {
            ...
            var isCulling = !((_mainRenderer$node$ge = mainRenderer.node.getComponent(CubismDrawable)) != null && _mainRenderer$node$ge.isDoubleSided);
