System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ComponentExtensionMethods;
      ...
      (function (_ComponentExtensionMethods) {
        function getComponentsMany(self, classConstructor) {
          ...
          for (var i = 0; i < self.length; i++) {
            var range = self[i].getComponents(classConstructor); // Skip empty ranges.
        ...
        function addComponentEach(self, classConstructor) {
          var components = new Array(self.length);
...
//# sourceMappingURL=555b87b851b985dbfae63c74b576ae6eaeb24d9e.js.map