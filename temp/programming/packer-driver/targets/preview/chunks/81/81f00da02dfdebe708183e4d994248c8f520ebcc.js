      ...
      CubismPhysics3Json = class CubismPhysics3Json {
        ...
        static loadFromJson(json) {
          ...
          if (Array.isArray(json.PhysicsSettings)) {
            var physicsSettings = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
        ...
        toRig() {
          var instance = new (_crd && CubismPhysicsRig === void 0 ? (_reportPossibleCrUseOfCubismPhysicsRig({
            error: Error()
          ...
          if (this.physicsSettings != null) {
            ...
            for (var i = 0; i < instance.subRigs.length; i++) {
              var subRig = new (_crd && CubismPhysicsSubRig === void 0 ? (_reportPossibleCrUseOfCubismPhysicsSubRig({
                error: Error()
      ...
      (function (_CubismPhysics3Json) {
        ...
        class SerializablePhysicsSettings {
          ...
          static instantiateFromJson(json) {
            ...
            var id = asString(json.Id);
            var input = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
            }), JsonParseUtils) : JsonParseUtils).arrayedInstantiateFromJson(json.Input, SerializableInput.instantiateFromJson);
            var output = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
            }), JsonParseUtils) : JsonParseUtils).arrayedInstantiateFromJson(json.Output, SerializableOutput.instantiateFromJson);
            var vertices = (_crd && JsonParseUtils === void 0 ? (_reportPossibleCrUseOfJsonParseUtils({
              error: Error()
