        ...
        static toSetInstance(fadeMotion, motion3Json, motionName, motionLength, shouldImportAsOriginalWorkflow, isCallFormModelJson) {
          ...
          if (parameterIds != null && parameterFadeInTimes != null && parameterFadeOutTimes != null) {
            ...
            for (var i = 0; i < jsonCurves.length; i++) {
              ...
              var keys = (_crd && CubismMotion3Json === void 0 ? (_reportPossibleCrUseOfCubismMotion3Json({
                error: Error()
              ...
              for (var j = 0; j < keys.length; j++) {
                ...
                var keyFrame = new (_crd && CubismSerializableKeyFrame === void 0 ? (_reportPossibleCrUseOfCubismSerializableKeyFrame({
                  error: Error()
      ...
      (function (_CubismSerializableCurves) {
        function instantiateFromJson(src) {
          ...
          for (var i = 0; i < src.length; i++) {
            var curve = (_crd && CubismSerializableCurve === void 0 ? (_reportPossibleCrUseOfCubismSerializableCurve({
              error: Error()
