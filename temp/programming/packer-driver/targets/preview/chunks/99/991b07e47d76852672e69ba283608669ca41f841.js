    ...
    execute: function () {
      ...
      _export("default", CubismRenderer = (_dec = ccclass('CubismRenderer'), _dec2 = requireComponent(MeshRenderer), _dec3 = property({
        ...
        applySorting() {
          ...
          var offset = this.sortingMode == (_crd && CubismSortingMode === void 0 ? (_reportPossibleCrUseOfCubismSortingMode({
            error: Error()
        ...
        tryInitializeMesh() {
          ...
          var drawable = this.getComponent(_crd && CubismDrawable === void 0 ? (_reportPossibleCrUseOfCubismDrawable({
            error: Error()
