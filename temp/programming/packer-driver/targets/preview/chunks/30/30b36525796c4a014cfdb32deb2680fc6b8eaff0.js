    ...
    execute: function () {
      ...
      _export("default", CubismModel = (_dec = ccclass('CubismModel'), _dec2 = property({
        ...
        revive() {
          ...
          var model = (_crd && CubismTaskableModel === void 0 ? (_reportPossibleCrUseOfCubismTaskableModel({
            error: Error()
        ...
        reset(moc) {
          ...
          var parameters = (_crd && CubismParameter === void 0 ? (_reportPossibleCrUseOfCubismParameter({
            error: Error()
          }), CubismParameter) : CubismParameter).createParameters(unmanagedModel);
          var parts = (_crd && CubismPart === void 0 ? (_reportPossibleCrUseOfCubismPart({
            error: Error()
          }), CubismPart) : CubismPart).createParts(unmanagedModel);
          var drawables = (_crd && CubismDrawable === void 0 ? (_reportPossibleCrUseOfCubismDrawable({
            error: Error()
