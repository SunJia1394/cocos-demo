System.register(["cc", "__unresolved_0", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, CubismUserDataBody, CubismUserDataTargetType, JsonParseUtils, CubismUserData3Json, asNumber, asString;
  ...
  return {
    setters: [function (_cc) {
      ...
      CubismUserDataTargetType = _unresolved_2.default;
    }, function (_unresolved_3) {
      JsonParseUtils = _unresolved_3.default;
    }],
    execute: function () {
      ...
      CubismUserData3Json = class CubismUserData3Json {
        ...
        static loadFrom(userData3Json) {
          var json = JsonParseUtils.parse(userData3Json);
        ...
        static loadFromJson(json) {
          var version = JsonParseUtils.asNumber(json.Version);
          var meta = CubismUserData3Json.SerializableMeta.instantiateFromJson(json.Meta);
          var userData = JsonParseUtils.arrayedInstantiateFromJson(json.UserData, CubismUserData3Json.SerializableUserData.instantiateFromJson);
...
//# sourceMappingURL=cd70ce8a181c78386c8de4bff1dd33ebbb5b2542.js.map