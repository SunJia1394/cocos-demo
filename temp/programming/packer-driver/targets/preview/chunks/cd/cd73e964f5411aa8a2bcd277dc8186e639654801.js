  ...
  return {
    ...
    execute: function () {
      ...
      _export("CubismLookController", CubismLookController = (_dec = ccclass('CubismLookController'), _dec2 = property({
        ...
        refresh() {
          var model = CoreComponentExtensionMethods.findCubismModel(this);
        ...
        onLateUpdate() {
          ...
          if (position != this.goalPosition) {
            var temp = MathExtensions.Vec3.smoothDamp(position, this.goalPosition, this.velocityBuffer, this.damping);
            position = temp[0];
