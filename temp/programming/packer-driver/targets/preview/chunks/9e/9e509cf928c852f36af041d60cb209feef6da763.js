    ...
    execute: function () {
      ...
      _export("default", CubismExp3Json = class CubismExp3Json {
        ...
        static loadFrom(exp3Json) {
          var json = JsonParseUtils.parse(exp3Json);
        ...
        static loadFromJson(json) {
          ...
          var parameters = JsonParseUtils.arrayedInstantiateFromJson(json.Parameters, SerializableExpressionParameter.instantiateFromJson);
