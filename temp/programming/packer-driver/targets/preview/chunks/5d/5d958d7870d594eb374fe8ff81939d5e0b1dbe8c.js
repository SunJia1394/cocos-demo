    ...
    execute: function () {
      ...
      _export("default", CubismPoseController = (_dec = ccclass('CubismPoseController'), _dec2 = property({
        ...
        refresh() {
          ...
          var tags = (_crd && ComponentExtensionMethods === void 0 ? (_reportPossibleCrUseOfComponentExtensionMethods({
            error: Error()
          ...
          for (var i = 0; i < tags.length; i++) {
            ...
            if (arr.length <= partIndex) {
              ...
              arr.fill(new (_crd && CubismPoseData === void 0 ? (_reportPossibleCrUseOfCubismPoseData({
                error: Error()
              }), CubismPoseData) : CubismPoseData)(), _start, partIndex + 1);
            }
            ...
            for (var j = 0; j < tags[i].link.length; j++) {
              ...
              var _part = (_crd && ArrayExtensionMethods === void 0 ? (_reportPossibleCrUseOfArrayExtensionMethods({
                error: Error()
