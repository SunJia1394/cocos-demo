    ...
    execute: function () {
      ...
      _export("default", CubismRaycaster = (_dec = ccclass('CubismRaycaster'), _dec(_class = class CubismRaycaster extends Component {
        ...
        refresh() {
          ...
          var candidates = (_ComponentExtensionMe = (_ComponentExtensionMe2 = ComponentExtensionMethods.findCubismModel(this)) == null ? void 0 : _ComponentExtensionMe2.drawables) != null ? _ComponentExtensionMe : null;
          ...
          for (var i = 0; i < candidates.length; i++) {
            ...
            var renderer = candidates[i].getComponent(CubismRenderer);
        ...
        raycast2(ray, result, maximumDistance) {
          ...
          var origin = Vector3.from(ray.o);
          var direction = Vector3.from(ray.d);
          var intersectionInWorldSpace = origin.add(direction.multiplySingle(direction.z / origin.z));
          var intersectionInLocalSpace = Vector3.from(this.node.inverseTransformPoint(new math.Vec3(), intersectionInWorldSpace.toBuiltinType()));
