      ...
      _export("default", CubismRenderController = (_dec = ccclass('CubismRenderController'), _dec2 = property({
        ...
        set sortingMode(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i = 0; _i < renderers.length; _i++) {
              console.assert(renderers[_i][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
              }), InEditorSymbols) : InEditorSymbols).onControllerSortingModeDidChange] != null);

              renderers[_i][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
        ...
        set sortingOrder(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i2 = 0; _i2 < renderers.length; _i2++) {
              console.assert(renderers[_i2][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
              }), InEditorSymbols) : InEditorSymbols).onControllerSortingOrderDidChange] != null);

              renderers[_i2][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
        ...
        set depthOffset(value) {
          ...
          if (!EDITOR) {
            ...
            for (var _i3 = 0; _i3 < renderers.length; _i3++) {
              console.assert(renderers[_i3][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
              }), InEditorSymbols) : InEditorSymbols).onControllerDepthOffsetDidChange] != null);

              renderers[_i3][(_crd && InEditorSymbols === void 0 ? (_reportPossibleCrUseOfInEditorSymbols({
                error: Error()
        ...
        tryInitializeRenderers() {
          ...
          if (renderers == null || renderers.length == 0) {
            ...
            var drawables = (_findCubismModel$draw = (_findCubismModel = (_crd && CoreComponentExtensionMethods === void 0 ? (_reportPossibleCrUseOfCoreComponentExtensionMethods({
              error: Error()
