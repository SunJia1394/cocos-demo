  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", CubismUpdateController = (_dec = ccclass('CubismUpdateController'), _dec(_class = executeInEditMode(_class = class CubismUpdateController extends Component {
        ...
        refresh() {
          var model = ComponentExtensionMethods.findCubismModel(this); // Fail silently...
          ...
          var components = model.getComponents(Component).filter((value, index, array) => ICubismUpdatable.isImplements(value));
