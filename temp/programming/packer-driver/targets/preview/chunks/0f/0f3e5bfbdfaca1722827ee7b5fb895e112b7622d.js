    ...
    execute: function () {
      ...
      _export("default", CubismPhysicsController = (_dec = ccclass('CubismPhysicsController'), _dec2 = property({
        ...
        onLateUpdate(deltaTime) {
          ...
          var _deltaTime = deltaTime; // Use fixed delta time if required.
        ...
        stabilization() {
          ...
          var renderController = this.getComponent(_crd && CubismRenderController === void 0 ? (_reportPossibleCrUseOfCubismRenderController({
            error: Error()
          }), CubismRenderController) : CubismRenderController);
          var maskController = this.getComponent(_crd && CubismMaskController === void 0 ? (_reportPossibleCrUseOfCubismMaskController({
            error: Error()
